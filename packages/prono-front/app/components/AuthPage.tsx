    ...
    <div className="min-h-screen bg-[#FAF9F6] flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600">Connectez-vous pour commencer à pronostiquer</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-[#548CB4] bg-opacity-10 border border-[#548CB4]">
          <p className="text-sm text-center text-gray-700">
            <span style={{ fontWeight: 600 }}>Mode démo :</span> Utilisez n'importe quel email/mot de passe pour tester l'application
          </p>
        </div>
      </div>
    </div>

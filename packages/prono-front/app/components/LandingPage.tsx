...
export function LandingPage({
	...
	return (
		<div className="min-h-screen bg-[#FAF9F6]">
			...
			<div className="relative overflow-hidden">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-16 sm:pb-32">
					<div className="text-center max-w-4xl mx-auto">
						<h1 className="mb-6">League of Prono</h1>

						<p className="text-gray-600 mb-8 sm:mb-12">
							Créez des groupes privés avec vos amis et prouvez qui est le
							meilleur pronostiqueur sur les matchs e-sport de League of
							Legends.
						</p>
			...
			>
				<div className="text-center mb-12 sm:mb-16">
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Une plateforme simple et élégante pour partager votre passion de
						l'e-sport avec vos amis
					</p>
				</div>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
					...
					<div className="bg-white border border-[#E5E4E1] p-8 hover:border-[#548CB4] transition-colors">
						...
						<p className="text-gray-600">
							Créez des groupes fermés avec vos amis. Partagez simplement un
							code d'invitation pour que vos amis vous rejoignent.
						</p>
					</div>
					...
					<div className="bg-white border border-[#E5E4E1] p-8 hover:border-[#548CB4] transition-colors">
						...
						<p className="text-gray-600">
							Prédisez le vainqueur et le score exact des matchs. Plus vous êtes
							précis, plus vous gagnez de points.
						</p>
					</div>
					...
					<div className="bg-white border border-[#E5E4E1] p-8 hover:border-[#548CB4] transition-colors">
						...
						<p className="text-gray-600">
							Suivez en temps réel votre position dans chaque groupe et
					...
					<div className="bg-white border border-[#E5E4E1] p-8 hover:border-[#548CB4] transition-colors">
						...
						<p className="text-gray-600">
							Pas de frais cachés, pas d'abonnement. League of Prono est et
							restera totalement gratuit.
						</p>
					</div>
				</div>
			</div>
			...
			<div
				id="how-it-works"
				className="bg-white border-y border-[#E5E4E1] py-16 sm:py-24"
			>
				<div className="max-w-7xl mx-auto px-4 sm:px-6">
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12">
						<div className="text-center">
							<div
								className="w-16 h-16 bg-[#548CB4] text-white flex items-center justify-center mx-auto mb-6 text-2xl"
							...
							<p className="text-gray-600">
								Créez votre propre groupe ou rejoignez celui de vos amis avec un
								simple code d'invitation.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Prédisez le vainqueur et le score de chaque match avant qu'il ne
								commence. Modifiez tant qu'il n'est pas trop tard !
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Accumulez des points à chaque bon pronostic et grimpez dans le
								classement de votre groupe !
							</p>
						</div>
					</div>
				</div>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
				<div className="bg-linear-to-br from-[#548CB4] to-[#4a7ca0] text-white p-16 text-center">
					...
					<p className="text-xl mb-8 opacity-90">
						Rejoignez League of Prono dès aujourd'hui et commencez à rivaliser
						avec vos amis
					</p>
					<Button
						onClick={onGetStarted}

...
export function PredictionModal({ match, groupId, isOpen, onClose, onSubmit }: PredictionModalProps) {
  ...
  const handleSubmit = () => {
    ...
    onSubmit({
      ...
      predictedScoreA: scoreA ? parseInt(scoreA) : undefined,
      predictedScoreB: scoreB ? parseInt(scoreB) : undefined,
    });
      ...
      <DialogContent className="max-w-2xl bg-white border-[#E5E4E1]">
        ...
        <div className="space-y-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              ...
              >
                <div className="text-center">
                  <div className="text-lg sm:text-2xl mb-2" style={{ fontWeight: 600 }}>
                    {match.team_a}
                  </div>
                  {selectedWinner === "team_a" && (
                    <div className="text-xs sm:text-sm text-[#548CB4]" style={{ fontWeight: 600 }}>
                      ✓ Sélectionné
                    </div>
                  )}
                </div>
              ...
              >
                <div className="text-center">
                  ...
                  {selectedWinner === "team_b" && (
                    <div className="text-sm text-[#548CB4]" style={{ fontWeight: 600 }}>
                      ✓ Sélectionné
                    </div>
                  )}
                </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-6">
              <div className="flex-1">
                <Label htmlFor="scoreA" className="text-xs sm:text-sm text-gray-600 mb-2 block">
                  {match.team_a}
                </Label>
                <Input
                  id="scoreA"
              ...
              <div className="flex-1">
                <Label htmlFor="scoreB" className="text-xs sm:text-sm text-gray-600 mb-2 block">
                  {match.team_b}
                </Label>
                <Input
                  id="scoreB"
          ...
          <div className="bg-[#F5F4F1] p-4 text-sm text-gray-600">
            <p style={{ fontWeight: 600 }} className="mb-2">Règles de scoring :</p>
            <ul className="space-y-1">
              <li>• Vainqueur correct : <span style={{ fontWeight: 600 }}>3 points</span></li>
              <li>• Score exact : <span style={{ fontWeight: 600 }}>3 + 2 points bonus = 5 points</span></li>
            </ul>
          </div>
        </div>

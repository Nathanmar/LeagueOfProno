...
const merchItems: MerchItem[] = [
  {
    ...
    price: 29.99,
    image: "https://images.unsplash.com/photo-1629917629391-47d9209b7c19?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtZXJjaGFuZGlzZXxlbnwxfHx8fDE3NjE1NzU0OTB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    category: "riot",
    inStock: true
  },
  {
  ...
  },
  {
    ...
    price: 34.99,
    image: "https://images.unsplash.com/photo-1641085809270-71f722611ce1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwbHVzaCUyMHRveSUyMGN1dGV8ZW58MXx8fHwxNzYxNTc1NDkwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
...
export function Shop({ onBack, isAuthenticated, onLogin }: ShopProps) {
  ...
  const handleRedeemGiftCard = (card: GiftCard, value: number) => {
    ...
    if (currentUser.total_points >= totalCost) {
      toast.success(`Carte cadeau ${card.name} de ${value}€ échangée avec succès !`);
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between h-16">
              ...
              >
                ...
                <span className="text-xl" style={{ fontWeight: 700 }}>League of Prono</span>
              </button>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mb-3">
                    Connectez-vous pour échanger vos points contre des cartes cadeaux.
                  </p>
                  <Button
                    onClick={onLogin}
                    className="bg-[#548CB4] hover:bg-[#4a7ca0] text-white"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Échangez vos points gagnés en faisant des pronostics contre des cartes cadeaux digitales. 
                  Les codes vous seront envoyés par email sous 24h.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {card.values.map(value => {
                      ...
                      const canAfford = isAuthenticated && currentUser.total_points >= cost;
                      ...
                      return (
                        <button
                          ...
                          className={`p-4 border-2 transition-all ${
                            selectedGiftCard === card.id && selectedValue === value
                        ...
                        >
                          <div style={{ fontWeight: 700 }} className="text-lg mb-1">
                            {value}€
                          </div>
                  ...
                  {selectedGiftCard === card.id && selectedValue !== null && (
                    <Button
                      onClick={() => handleRedeemGiftCard(card, selectedValue)}
        ...
        <TabsContent value="merch">
          <div className="bg-[#F5F4F1] p-6 mb-8 border-l-4 border-[#C4A15B]">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Découvrez notre sélection de produits Riot Games et nos articles exclusifs League of Prono. 
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {merchItems.filter(item => item.category === "riot").map(item => (
                <div
                  key={item.id}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {merchItems.filter(item => item.category === "league-of-prono").map(item => (
                <div
                  key={item.id}
                ...
                >
                  <div className="relative aspect-square bg-gray-100">
                    ...
                    <Badge 
                      className="absolute top-3 right-3 bg-[#C4A15B] text-white"
                    >
                      Exclusif
                    </Badge>
                  </div>
